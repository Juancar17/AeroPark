...
const Reservar = () => {
  ...
  const calcularCoste = (e) => {
    ...
    // Calcular el coste
    const costeTotal = 20 + (diffDays - 1) * 5;
    setCoste(costeTotal);
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          ...
          >
            ...
            <p>
              Del dia <span className="font-bold">{formData.diaRecogida}</span>{" "}
              al <span className="font-bold">{formData.diaEntrega}</span>{" "}
            </p>
            <button
            ...
            <button
              ...
              className="mt-6 ml-2 bg-green-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition duration-300"
            >
              Continuar
            </button>
          </motion.div>
